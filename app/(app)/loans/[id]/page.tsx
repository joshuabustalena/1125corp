...
export default function LoanDetailPage() {
  ...
  async function handleConfirmApprove() {
    ...
    if (error) {
      ...
      logAudit({ action: 'approve', entityType: 'loans', entityId: loan.id, details: { loan_number: loan.loan_number }, userId: profile?.id ?? null });
  ...
  async function handleDecline() {
    ...
    if (error) {
      ...
      logAudit({ action: 'reject', entityType: 'loans', entityId: loan.id, details: { loan_number: loan.loan_number, reason: declineReason.trim() }, userId: profile?.id ?? null });
