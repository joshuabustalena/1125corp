...
export default function PaymentReportsPage() {
  ...
  async function handleGeneratePdf() {
    ...
    try {
      ...
      // Convert from the canvas's raw pixel buffer (CSS px * scale) to PDF points
      // (96 CSS px = 72pt) ourselves, rather than trusting jsPDF's own 'px' unit
      // conversion, which produced a mismatched/cropped page in testing.
      const pxToPt = 0.75;
      ...
      // Scale the wide report down to the portrait page's width, then slice
      // the remaining height across as many pages as needed.
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Hidden professional report template, captured to PDF on "Generate PDF Report".
          Portaled directly onto <body> so no transformed/overflow-hidden ancestor
          in the app layout can clip this fixed-position element during capture. */}
