  ...
  return (
    ...
    >
      {/* Textured cover background — same brand image as the login page,
          heavily darkened/blended so it adds texture without hurting the
          nav text's legibility. */}
      <div className="absolute inset-0 bg-[#0b1f3a]" />
      <div
        className="absolute inset-0 opacity-[0.18] mix-blend-luminosity bg-cover bg-center"
        style={{ backgroundImage: "url('/image/coverbackground.png')" }}
      />
      <div className="absolute inset-0 bg-gradient-to-b from-[#0b1f3a]/85 via-[#0b1f3a]/75 to-[#0b1f3a]/95" />
